...
local function date_widget(date, is_current, is_another_month)
  ...
  if is_current == true then
    text_color = beautiful.calendar.current_day_fg
  elseif is_another_month == true then
    text_color = beautiful.calendar.other_month_day_fg
  end
  ...
  return wibox.widget {
    ...
    bg = is_current and beautiful.calendar.current_day_bg or beautiful.calendar.other_month_day_bg,
    wtext {
      halign = "center",
      size = 12,
      color = text_color,
...
local function new()
  ...
  ret.month = wtbutton.normal {
    normal_fg = beautiful.calendar.month_fg,
    forced_height = dpi(30),
  ...
  local month = wibox.widget {
    ...
    wtbutton.normal {
      ...
      size = 12,
      halign = "center",
      normal_fg = beautiful.calendar.month_change_icon_fg,
  ...
  ret.days = wibox.widget {
    ...
    forced_num_rows = 6,
    forced_num_cols = 7,
    spacing = beautiful.calendar.days_spacing,
    expand = true,
  }
