...
theme.accent                                = theme.colors.blue

-- Default corner radius for UI elements.
theme.corner_radius                         = dpi(6) -- to match picom, 8px

-- Client decoration config (borders)
theme.useless_gap                           = dpi(8)
theme.border_width                          = 0
theme.border_color_normal                   = theme.colors.black
...
theme.titlebar_bg_focus                     = theme.colors.darker_black
theme.titlebar_bg_normal                    = theme.colors.darker_black
...
theme.notification_alt_bg                   = theme.colors.darker_black
...
theme.notification_paddings                 = dpi(6)
...
theme.layout_picker_bg                      = theme.colors.black
theme.layout_picker_alt_bg                  = theme.colors.darker_black
theme.layout_picker_paddings                = dpi(6)
...
theme.layoutlist_bg_normal                  = theme.layout_picker_bg
theme.layoutlist_bg_selected                = theme.colors.onebg

-- Layout picker settings.
theme.systray_bg                            = theme.colors.black
theme.systray_alt_bg                        = theme.colors.darker_black
theme.systray_paddings                      = dpi(6)
...
theme.taglist_item_width_occupied           = dpi(8)
...
theme.app_launcher_prompt_paddings          = dpi(6)
-- -*- App item setting.
...
theme.calendar_bg                           = theme.colors.black
theme.calendar_alt_bg                       = theme.colors.darker_black
theme.calendar_paddings                     = dpi(12)

-- Power screen settings.
theme.power_screen_bg                       = theme.colors.black .. '2c'
...
theme.wallpaper = AWESOME_CONFIG_HOME .. '/theme/wall.jpg'
