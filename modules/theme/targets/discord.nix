...
with lib; {
  options.fht.theme.targets.discord = {
    enable =
      mkBoolOpt' false "Whether to enable the Discord chat client theme.";
  };
  ...
  in
    mkIf cfg.enable {
      home.xdg.configFile."BetterDiscord/themes/${theme.name}.theme.css".text = with theme.colors.withHashtag; ''
        /**
         * @name Ultra, with real-fht colors.
         * @version 1.0.7
         * @author TheCommieAxolotl#0001, real-fht#7409
         * @authorId 538487970408300544, 635037049862357009
         * @description A Smooth, Black theme, recolored!
        ...
        */
        ...
        .reactionMe-1PwQAc {
            background-color: ${onebg}31 !important;
            border-color: ${onebg} !important;
        }
        ...
        .theme-dark {
            ...
            --background-secondary: ${black2};
            --background-secondary-alt: ${statusline};
            --background-tertiary: ${darker_black};
            --background-accent: ${black};
            --background-floating: var(--background-secondary);
            --background-message-hover: ${oneb3}15;
            --channeltextarea-background: var(--background-secondary);
            --modal-background: ${black};

            --background-mentioned: #${accent}10;
            --background-mentioned-hover: #${accent}15;
            ...
            --brand-experiment-hover: ${accent}4d;
            --brand-experiment-560: ${accent};
            --channels-default: ${grey_fg2};
            --selected-indicator: ${green}DD;
            --hover-indicator: ${white};
            --font: "monospace", "Twitter Color Emoji", Sans, "Sans Serif";
            --code-font: "monosapce";
            --boost-bar: none;
